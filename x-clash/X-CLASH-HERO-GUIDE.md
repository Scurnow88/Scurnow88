...
| **Romano** | Holy Inquisitor | Nightfall | DPS (Physical) | **158% Cleanse Heresy** + **145% Piercing Fists (CS)** ✅ *(3 skills)* |
...
| Status | Count | Heroes |
|--------|-------|--------|
| ✅ **Complete** | **31/31** | All heroes verified — Edric dmg skill + Romano innate (Unyielding Fortitude) added |
| ⏳ **Partial** | **0/31** | — |
